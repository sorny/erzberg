...
The sidebar's **preset thumbnails** are a different set, generated by
`npm run thumbs` into `public/presets/thumbs/` (WebP, 320×200) because they ship
with the app rather than with the documentation. Same idea, same exporter — see
