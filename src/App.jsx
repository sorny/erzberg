...
const STYLE_DEF = {
  ...
  majorIntervalContours: 10, majorWeightContours: 2, majorOffsetContours: 1, closeRingsContours: false, smoothContours: 0,
  // Hachure
  ...
  const levaSet = useCallback((vals) => {
    ...
    Object.keys(vals).forEach(k => {
      if (k.startsWith('enabled') || k.startsWith('spacing') || k.startsWith('shift') || 
          ...
          k.startsWith('step') || k.startsWith('pillar') || k.startsWith('major') || k.startsWith('closeRings') || k.startsWith('smooth')) {
        s[k] = vals[k]
      }
    })
