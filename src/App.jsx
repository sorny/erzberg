...
export default function App() {
  ...
  const p = { ...terrain, ...style, ...points, ...view, gradientStops,
     ...
     */
    // Copied, not converted. Both are true bearings now: `hillshadeAzimuth` was a
    // quarter turn from a compass until v1.14.0, and this line carried the
    // correction that the migration made unnecessary.
    ...(sun ? {
      hillshadeAzimuth: sun.azimuth,
