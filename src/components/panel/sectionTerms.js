...
export const SECTION_TERMS = {
  ...
  'Draw Modes':       'index grid overview marks glyphs which modes are on forty-one all',
  ...
  'Mode: Single Line': 'tsp travelling salesman continuous one line single stroke stipple tour 2-opt plotter portrait',
  'Mode: Shadow Hatch': 'cast shadow cross hatch hatching ray sun mask engraving terminator 45 boolean',
  'Mode: Isochrones': 'isochrone walking time travel hike hiking tobler minutes hours distance reach hut accessibility dijkstra',
  'Mode: Truchet': 'truchet tiles smith arcs quarter circles pattern chains aspect downhill',
  'Mode: Viewshed': 'viewshed visibility line of sight visible hidden seen observer eye lookout tower summit panorama',
  'Mode: Route': 'route path least cost shortest fastest walk hike trail tobler dijkstra between two points',
